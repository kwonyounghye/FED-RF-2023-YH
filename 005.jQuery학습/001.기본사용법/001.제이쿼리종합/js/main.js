...
// 자바스크립트 코드랑 jquery 코드를 섞어서 쓸 수 없음
// document.querySelectorAll('.mz').forEach((ele)=>ele.style.display='none');/* javascript코드 */
// 좀비는 모두 숨기기
$(".mz").hide();
...
btns.hide().first().show(); /* .을 쓰기만 해도 자동 for문 */
// 버튼들.숨겨().첫번째().보여()
// btns.hide().eq(4).show()
