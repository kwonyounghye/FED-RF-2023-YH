...
$(() => {
    ...
    $("html, body").on("mousedown mouseup mousemove", () => {
        // 1. 움직이는 대상 left 위치값
        let tgPos = target.offset().left; // 불러놓고 left
