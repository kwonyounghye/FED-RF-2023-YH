...
$(() => {
    ...
    $(".dropshow").droppable({
        ...
        `); //////// html /////////
            ...
            mbox.append(`
        <iframe src="https://www.youtube.com/embed/${mvId}?autoplay=1" 
        allow="autoplay" style="width:100%;height:100%;border:none"></iframe>
        `)

        // 9. 동영상박스 숨기고 1초 후 slideDown으로 보이기
        .hide().delay(1000).slideDown(2000);

        // 10. 닫기버튼 셋팅 및 클릭 시 동영상 닫기
            mbox.find('a')
            .css({
                position: "absolute",
                top: "50px",
