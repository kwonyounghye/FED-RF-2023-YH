...
// [중요!!] 뷰인스턴스에 라우터를 등록해줘야 함!
// -> new Vue({el:"", router, methods:{}})

// [중요!!]
// 뷰 인스턴스에 스토아를 사용할 수 있게 등록해줘야함!
...
Vue.component('top-area',{
    // (1) 템플릿 설정하기
    // Object.keys.entries 키값을 모아서 배열로 만들어줌
    // Object.keys - 값만 보내려면 앞에 있는 속성명만으로 보내줌
    template: `
    <header>
        <ul class="gnb">
