...
// 'data-num' -> this.dataNum 
  ...
  data () {
    ...
    return {
      ...
      // 2. 상품명 : data-num 값이 짝수/홀수에 따라 아이콘 변경
      gname: 'DE-'+this.setName()+this.endLet
      +(this.dataNum%2?"🌘":"🌒"),
      // 3. 상품가격
      gprice: this.setPrice(),
      // 4. 세일가격 : 상품 원래 가격의 30% 세일
      // (원가격 *0.7)
      // -> 외부의 전역변수 temp에 원가격이 있음
...
new Vue({
  ...
  mounted(){
    ...
    // 닫기버튼 셋팅
    $('.cbtn').click((e)=>{e.preventDefault(); $('#bgbx').hide()});
