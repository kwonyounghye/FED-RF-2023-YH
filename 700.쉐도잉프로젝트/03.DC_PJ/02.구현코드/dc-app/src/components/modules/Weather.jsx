...
class Weather extends Component {
    ...
    constructor(props) {
        ...
        // -> 값의 셋팅은 setState라고 씀(함수형과 같지만 처음 선언 시 없음)
    } /////////// 생성자함수 /////////////
    // 컴포넌트 생성 후 날씨정보 조회하여 화면에 보이기
    // 함수형 컴포넌트에서는 랜더링 후 useEffect()이지만
    ...
    componentDidMount() {
        ...
        // .then(wdata=>{ // 파일 받은 후 내용 읽기
        //     console.log(wdata, wdata.main.temp);
        //     // 상태변수인 wInfo에 값을 셋팅한다!
        //     // 셋팅용 상태변수 메서드형은 setState()
        //     // this 키워드 사용
        //     this.setState({temp:wdata.main.temp, desc:wdata.weather[0].description,icon:wdata.weather[0].icon,loading:false,city:cityName})
        // }) /////// 마지막 then /////////
        // // 에러 시 처리
        // .catch(err=>console.log(err));
        ///////////////////////////
