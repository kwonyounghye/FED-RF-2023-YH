...
export function Member() {
    ...
    const totalValid = () => {
        ...
        // 2. 통과 시 true, 불통과 시 false 리턴 처리
        // 통과조건 : 빈값 아님 + 에러 후크 변수가 모두 false
        if (
            userId &&
            pwd &&
            chkPwd &&
    ...
    const onSubmit = (e) => {
        ...
        if (totalValid()) {
            // alert('OK!');
            // 회원가입 정보를 로컬 스토리지에 저장하기

            // 로컬 스토리지 체크함수 호출(없으면 생성함!)
            initData();
            ...
            document.querySelector(".sbtn").innerText = "넌 이제 회원이다.";
        } ////// if /////////
        // 3. 불통과 시
        else {
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input
                                type="password"
                                maxLength="20"
                                placeholder="please enter your Comfirm Password"
                                value={chkPwd}
