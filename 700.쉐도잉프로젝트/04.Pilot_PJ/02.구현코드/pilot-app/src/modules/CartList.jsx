...
export const CartList = memo(({ selData, flag }) => {
    ...
    // 2. 변경 데이터 변수 : 전달된 데이터로 초기셋팅 / 업데이트 되지 않고 값을 유지함(+useRef)
    ...
    // 삭제 버튼도 작동하게 하려면? -> 상태변수로 제어한다!!!!!!!!
    // 외부데이터 업데이트는 flag.current값이 true까지 되야한다!
  ...
  *************************************/
  const chgList = (e) => {
    ...
    return (
        <>
            <section id="cartlist">
                <a href="#" class="cbtn cbtn2" onClick={hideList}>
                    <span>닫기버튼</span>
                </a>
                <table>
                    <caption>
