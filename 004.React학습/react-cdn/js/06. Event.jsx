...
function EventShow() {
    ...
    // 1. 컴포넌트 리턴은 가장 아랫쪽에서 함!
    return (
        <React.Fragment>
            <div id="tbox" style={{ textAlign: "center" }}>
                {/* 소원을 말해봐 이미지 출력 : onmouseover이벤트 적용 */}
                <img
...
// 이미지 생성 컴포넌트 ///////////////
function MakeImg(props) { // isrc - 이미지 경로 / ialt - 이미지설명
    // 비?집:놀이동산
    // 페라리와 
    // props.info -> true/false값을 보내서 처리함
    // true면 페라리용 이미지태그로 생성함
