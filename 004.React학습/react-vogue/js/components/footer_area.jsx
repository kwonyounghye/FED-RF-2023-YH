...
// 하단코드를 메모이제이션하기 위한 컴포넌트
// 만약 전달값 props가 없으면 없는 상태가
// 계속 유지되므로 재활용없이 다시 컴포넌트가
// 그려지는 일은 없게 됨! -> 중복실행하지 않는다!
    ...
    <React.Fragment>
      <div id="footer-area">
        <footer className="footer-area ibx common-area">
          {/* 3-1.하단로고 */}
          <div className="blogo">
            <img src={props.fsts==0?"./images/footer_logo.png":"https://media.tenor.com/roL8BtIs724AAAAd/vogue-celine-vogue.gif"} alt="하단로고" />
          </div>
          {/* 3-2.회사주소 */}
