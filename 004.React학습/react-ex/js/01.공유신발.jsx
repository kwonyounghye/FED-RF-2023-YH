...
function MainComponent() {
    ...
    // 4. JS 효과 적용 여부 상태관리변수
    const [effectOK, setEffectOK] = React.useState(1); /* 기본 적용됨 */
    /////////////////////////////////////////////////////
    ...
    /************************************************
    함수명: chgData
    기능: 상태관리변수 중 데이터 선택 번호 업데이트를
    하여 화면의 상품리스트를 업데이트 되게 한다!
  ************************************************/
    // 데이터 변경호출 함수 //////////
    const chgData = () => {
        console.log("바꿔~!");
    ...
    /************************************************
     ...
     (3) 효과 여부 : effectOK / setEffectOK
     기능: 상태변수 중 리스트/상세보기 선택변수를
     업데이트하여 실제뷰를 전환한다!
     ************************************************/
    ...
    return (
      ...
      ************************************************/}
            <div className="gwrap">
                {
                    // 상품리스트 컴포넌트 출력
                    subView == 0 && <GoodsCode idx={dataNum} chgFn={chgSubView} />
                }
                {
                    // 상품상세보기 컴포넌트 출력
                    ...
                    subView == 1 && <SubViewCode idx={dataNum} chgFn={chgSubView} itemNum={selItem} />
                }
            </div>
        </React.Fragment>
    );
