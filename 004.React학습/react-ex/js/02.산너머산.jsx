...
// 메인 컴포넌트
function MyHome(params) {
    return <MyRoom aa="세계의 산" bb="⛰️" />
}
// 일반적으로 props down할 때 props변구 하나를 써서
// 하위 (점 찍어서) 속성으로 접근했으나 줄괄호구역
// 즉, 리액트 코드구역을 쓰면 변수명을 갯수만큼 직접 사용 가능함!
...
function 큰집(params) {
    ...
    // Provider의 value 속성명은 정해진 것!
    // 여기에 할당하여 메인컴포넌트의 변수를 공유한다!
    return(
