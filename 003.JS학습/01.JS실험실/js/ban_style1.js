...
/* 
    ...
    2. 생성자 함수/클래스 : 파스칼케이스(모든 첫글자 대문자)
...
***************************************************/
    ...
    function clearAuto() {
        ...
        autoT = setTimeout(
            slideAuto,
            5000
        ); /* clearTimeout이 없으면 반대로 마구 누르고 몇 초 후 원래 방향으로 마구 넘어가게 됨 */
