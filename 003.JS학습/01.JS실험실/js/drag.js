...
function goDrag(ele) {
    ...
    // 1. 변수 셋팅
    // (1) 드래그 상태변수 : true - 드래그중, false - 드래그 아님
    let drag = false;
