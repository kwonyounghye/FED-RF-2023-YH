...
// import langCode from './data_lang.json' 어서써{type:'json'};
// 제이슨 import 맨 뒤에 assert(주장하다! 제이슨임을 주장해준다!)
// assert{type:'json'} -> 어서써 타입 제이슨!
// 원래 제이슨파일과 같은 데이터파일을 불러올 때는
// 데이터파일을 모두 불러온 후 그 데이터를 이용하는 
// 코드가 실행되도록하는 비동기코딩방식인 Promise를
//  사용하는 것이 원칙임! 
...
// 3. 이벤트 설정하기 //////////////////////////
// 3-1. 이벤트 종류 : 선택박스가 변경될 때 발생하는 이벤트는? change
