...
function showTime() {
    // 3. 시간찍기
// JS 시간날짜 객체 : date() 객체
const today = new Date(); // 생성자함수 첫글자는 대문자
// new 키워드로 내장객체의 인스턴스를 생성함!

    // 3-1. 년도찍기 : getFullYear()
    tt[0].innerText = today.getFullYear();
    // 참고: getYear()는 1900년을 뺀 연도가 나옴

    // 3-2. 월찍기 : getMonth()
    // let monthName = ["하하월","파파월","카카월","","","","","","","","","상그리아월"];
...
// //    -> 1부터 최대수는 올림 처리 / 0부터 최대수-1은 내림 처리

// // 중간 난수는?
// // 예) 4~12 사이 난수는?
// console.log("4~12 사이 난수: ", Math.ceil(Math.random() * 9) + 3);
