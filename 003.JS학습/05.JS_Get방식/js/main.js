...
*********************************************************/
// 서브 샵페이지를 호출하기 위한 GNB 링크 셋팅하기!
// 호출 시 Get02.html?키=값 형태로 호출함!
// 1. 대상 : #gnb a
...
/********************************************************* 
    ...
    -> 참고) encodeURI(), decodeURI() -> 전체 URL 처리 시 사용!
    -> 주의) 최신 브라우저에서 encodeURIComponent()를 안해도
    자동 인코딩 처리를 해주는데 모든 브라우저 지원이 아닌 것을
    고려해서 encodeURIComponent() 처리를 해주는 것이 정석이다!
